...
# Choropleth will error if states are missing
# Extra regions, countries, or states will be ignored
# Need to add a zero value for missing states.
...
#TODO - display more data when states are hovered over. This would help http://leafletjs.com/examples/choropleth/
